...
(function () {
  const DICT = {
    ...
    // Category labels
    'r.cat.sauna':     { nl: 'Sauna & IJsbaden',        en: 'Sauna & Ice Bath' },
    'r.cat.prive':     { nl: 'LUCA Privé',               en: 'LUCA Private' },
    'r.cat.massage':   { nl: 'Massages',                 en: 'Massages' },
    'r.cat.combi':     { nl: 'Combi · Sauna & Massage',  en: 'Combi · Sauna & Massage' },
    'r.cat.men':       { nl: 'Heren Special',            en: "Men's Special" },
    'r.cat.studio':    { nl: 'Studio LUCA',              en: 'Studio LUCA' },

    // SAUNA & IJSBADEN
    'r.svc.sauna30.name': { nl: 'Sauna & IJsbad — 30 min',       en: 'Sauna & Ice Bath — 30 min' },
    'r.svc.sauna30.desc': { nl: 'Ervaar 30 minuten sauna en ijsbaden en reset je lichaam met warmte en kou. Een krachtige combinatie die ontspant, verfrist en energie geeft. Inclusief gebruik van de kleedkamers en voorzieningen.',
                            en: 'Experience 30 minutes of sauna and ice bathing — reset your body with warmth and cold. A powerful combo that relaxes, refreshes and energises. Includes changing rooms and facilities.' },
    'r.svc.sauna60.name': { nl: 'Sauna & IJsbad — 60 min',       en: 'Sauna & Ice Bath — 60 min' },
    'r.svc.sauna60.desc': { nl: 'Ervaar 60 minuten sauna en ijsbaden en reset je lichaam met warmte en kou. Een krachtige combinatie die ontspant, verfrist en energie geeft. Inclusief gebruik van de kleedkamers en voorzieningen.',
                            en: 'Experience 60 minutes of sauna and ice bathing — reset your body with warmth and cold. A powerful combo that relaxes, refreshes and energises. Includes changing rooms and facilities.' },
    'r.svc.sauna90.name': { nl: 'Sauna & IJsbad — 90 min',       en: 'Sauna & Ice Bath — 90 min' },
    'r.svc.sauna90.desc': { nl: 'Ervaar 90 minuten sauna en ijsbaden en reset je lichaam met warmte en kou. Een krachtige combinatie die ontspant, verfrist en energie geeft. Inclusief gebruik van de kleedkamers en voorzieningen.',
                            en: 'Experience 90 minutes of sauna and ice bathing — reset your body with warmth and cold. A powerful combo that relaxes, refreshes and energises. Includes changing rooms and facilities.' },

    // LUCA PRIVÉ
    'r.svc.privedate2.name': { nl: 'Summer Date Deal — 2 personen',   en: 'Summer Date Deal — 2 guests' },
    'r.svc.privedate2.desc': { nl: 'Boek LUCA privé en geniet samen met je date van onze faciliteiten! (Je kan deze privé boeken vanaf 1 tot 2 personen.)',
                               en: 'Book LUCA Private and enjoy our facilities together with your date! (You can book private from 1 to 2 guests.)' },
    'r.svc.privedate2.note': { nl: 'Laat in opmerkingen weten met hoeveel personen', en: 'Let us know guest count in notes' },
    'r.svc.privedate46.name': { nl: 'Summer Date Deal — 4-6 personen', en: 'Summer Date Deal — 4-6 guests' },
    'r.svc.privedate46.desc': { nl: 'Boek LUCA privé en geniet samen als dubbel of tripel date van onze faciliteiten. (Je kan deze privé boeken tot 6 personen.)',
                                en: 'Book LUCA Private and enjoy our facilities together as a double or triple date. (You can book private up to 6 guests.)' },
    'r.svc.privedate46.note': { nl: 'Laat in opmerkingen weten met hoeveel personen', en: 'Let us know guest count in notes' },

    // MASSAGES
    'r.svc.buccal.name': { nl: 'Buccale massage — 30 min',   en: 'Buccal massage — 30 min' },
    'r.svc.buccal.desc': { nl: 'Uitgevoerd door een ervaren specialist. Een gezichtsmassage van binnenuit de mond, gericht op het ontspannen van de kaak en gezichtsspieren. Met een kalmerend effect op het zenuwstelsel en een natuurlijk liftend resultaat.',
                            en: 'Performed by an experienced specialist. A facial massage from inside the mouth, targeting jaw and facial muscles. Calming for the nervous system, naturally lifting result.' },
    'r.svc.relax30.name': { nl: 'Relax massage — 30 min',    en: 'Relax massage — 30 min' },
    'r.svc.relax30.desc': { nl: 'Uitgevoerd door een ervaren specialist. Een korte, gerichte behandeling die snel verlichting geeft bij spanning. Ideaal voor nek, rug of schouders.',
                            en: 'Performed by an experienced specialist. A short, targeted treatment that quickly relieves tension. Ideal for neck, back or shoulders.' },
    'r.svc.deep30.name':  { nl: 'Deep Tissue massage — 30 min', en: 'Deep Tissue massage — 30 min' },
    'r.svc.deep30.desc':  { nl: 'Diepwerkende techniek, uitgevoerd door een ervaren therapeut. Een diepe, langzame massage die spanning en knopen in de spieren verlicht. Zo ontspannen je spieren en voelt je lichaam weer los en soepel.',
                             en: 'Deep-working technique, performed by an experienced therapist. A deep, slow massage that releases tension and knots in the muscles. Your muscles relax and your body feels loose and supple again.' },
    'r.svc.relax60.name': { nl: 'Relax massage — 60 min',    en: 'Relax massage — 60 min' },
    'r.svc.relax60.desc': { nl: 'Uitgevoerd door een ervaren specialist. Een complete massage voor diepe ontspanning en herstel van lichaam en geest. Perfect om helemaal tot rust te komen.',
                            en: 'Performed by an experienced specialist. A full massage for deep relaxation and recovery of body and mind. Perfect for complete calm.' },
    'r.svc.deep60.name':  { nl: 'Deep Tissue massage — 60 min', en: 'Deep Tissue massage — 60 min' },
    'r.svc.deep60.desc':  { nl: 'Diepwerkende techniek, uitgevoerd door een ervaren therapeut. Een diepe, langzame massage die spanning en knopen in de spieren verlicht. Zo ontspannen je spieren en voelt je lichaam weer los en soepel.',
                             en: 'Deep-working technique, performed by an experienced therapist. A deep, slow massage that releases tension and knots in the muscles. Your muscles relax and your body feels loose and supple again.' },
    'r.svc.relax90.name': { nl: 'Relax massage — 90 min',    en: 'Relax massage — 90 min' },
    'r.svc.relax90.desc': { nl: 'Uitgevoerd door een ervaren specialist. Een intensieve en uitgebreide behandeling die alle aandacht geeft aan jouw lichaam. Voor ultieme ontspanning en een langdurig herstellend effect.',
                            en: 'Performed by an experienced specialist. An intensive and extensive treatment that gives full attention to your body. For ultimate relaxation and long-lasting restorative effect.' },
    'r.svc.deep90.name':  { nl: 'Deep Tissue massage — 90 min', en: 'Deep Tissue massage — 90 min' },
    'r.svc.deep90.desc':  { nl: 'Diepwerkende techniek, uitgevoerd door een ervaren therapeut. Een diepe, langzame massage die spanning en knopen in de spieren verlicht. Zo ontspannen je spieren en voelt je lichaam weer los en soepel.',
                             en: 'Deep-working technique, performed by an experienced therapist. A deep, slow massage that releases tension and knots in the muscles. Your muscles relax and your body feels loose and supple again.' },
    'r.svc.cupping.name': { nl: 'Vuur cupping — 30 min',    en: 'Fire cupping — 30 min' },
    'r.svc.cupping.desc': { nl: 'Uitgevoerd door een ervaren specialist. Een traditionele therapie waarbij verwarmde cups op de huid worden geplaatst om een vacuüm te creëren. Deze behandeling stimuleert de doorbloeding, ontspant gespannen spieren en ondersteunt het natuurlijke herstel van het lichaam. Ideaal bij spierpijn, stijfheid of behoefte aan diepe ontspanning.',
                            en: 'Performed by an experienced specialist. A traditional therapy where heated cups are placed on the skin to create a vacuum. Stimulates blood flow, relaxes tense muscles and supports natural recovery. Ideal for muscle pain, stiffness or deep relaxation.' },

    // COMBI
    'r.svc.combi30relax.name':  { nl: '30 min wellness & 30 min relax massage',  en: '30 min wellness & 30 min relax massage' },
    'r.svc.combi30relax.desc':  { nl: 'Geniet van onze combinatie deals. Sauna en/of ijsbaden en een relax massage naar keuze. Uitgevoerd door een ervaren specialist.',
                                  en: 'Enjoy our combination deals. Sauna and/or ice bath and a relax massage of your choice. Performed by an experienced specialist.' },
    'r.svc.combi30deep.name':   { nl: '30 min wellness & 30 min deep tissue massage', en: '30 min wellness & 30 min deep tissue massage' },
    'r.svc.combi30deep.desc':   { nl: 'Geniet van onze combinatie deals. Sauna en/of ijsbaden en een deep tissue massage naar keuze. Uitgevoerd door een ervaren therapeut.',
                                  en: 'Enjoy our combination deals. Sauna and/or ice bath and a deep tissue massage of your choice. Performed by an experienced therapist.' },
    'r.svc.combi60relax.name':  { nl: '60 min wellness & 60 min relax massage', en: '60 min wellness & 60 min relax massage' },
    'r.svc.combi60relax.desc':  { nl: 'Geniet van onze combinatie deals. Sauna en/of ijsbaden en een relax massage naar keuze. Uitgevoerd door een ervaren specialist.',
                                  en: 'Enjoy our combination deals. Sauna and/or ice bath and a relax massage of your choice. Performed by an experienced specialist.' },
    'r.svc.combi60deep.name':   { nl: '60 min wellness & 60 min deep tissue massage', en: '60 min wellness & 60 min deep tissue massage' },
    'r.svc.combi60deep.desc':   { nl: 'Geniet van onze combinatie deals. Sauna en/of ijsbaden en een deep tissue massage naar keuze. Uitgevoerd door een ervaren therapeut.',
                                  en: 'Enjoy our combination deals. Sauna and/or ice bath and a deep tissue massage of your choice. Performed by an experienced therapist.' },
    'r.svc.combi30relax60.name':{ nl: '30 min wellness & 60 min relax massage', en: '30 min wellness & 60 min relax massage' },
    'r.svc.combi30relax60.desc':{ nl: 'Geniet van onze combinatie deals. Sauna en/of ijsbaden en een relax massage naar keuze. Uitgevoerd door een ervaren specialist.',
                                  en: 'Enjoy our combination deals. Sauna and/or ice bath and a relax massage of your choice. Performed by an experienced specialist.' },
    'r.svc.combi30deep60.name': { nl: '30 min wellness & 60 min deep tissue massage', en: '30 min wellness & 60 min deep tissue massage' },
    'r.svc.combi30deep60.desc': { nl: 'Geniet van onze combinatie deals. Sauna en/of ijsbaden en een deep tissue massage naar keuze. Uitgevoerd door een ervaren therapeut.',
                                  en: 'Enjoy our combination deals. Sauna and/or ice bath and a deep tissue massage of your choice. Performed by an experienced therapist.' },
    'r.svc.combi60relax30.name':{ nl: '60 min wellness & 30 min relax massage', en: '60 min wellness & 30 min relax massage' },
    'r.svc.combi60relax30.desc':{ nl: 'Geniet van onze combinatie deals. Sauna en/of ijsbaden en een relax massage naar keuze. Uitgevoerd door een ervaren specialist.',
                                  en: 'Enjoy our combination deals. Sauna and/or ice bath and a relax massage of your choice. Performed by an experienced specialist.' },
    'r.svc.combi60deep30.name': { nl: '60 min wellness & 30 min deep tissue massage', en: '60 min wellness & 30 min deep tissue massage' },
    'r.svc.combi60deep30.desc': { nl: 'Geniet van onze combinatie deals. Sauna en/of ijsbaden en een deep tissue massage naar keuze. Uitgevoerd door een ervaren therapeut.',
                                  en: 'Enjoy our combination deals. Sauna and/or ice bath and a deep tissue massage of your choice. Performed by an experienced therapist.' },
    'r.svc.combi30buccal.name': { nl: '30 min wellness & 30 min buccale massage', en: '30 min wellness & 30 min buccal massage' },
    'r.svc.combi30buccal.desc': { nl: 'Geniet van onze combinatie deals. Sauna en/of ijsbaden en een buccale (kaak) anti-stress massage. Uitgevoerd door een ervaren specialist.',
                                  en: 'Enjoy our combination deals. Sauna and/or ice bath and a buccal (jaw) anti-stress massage. Performed by an experienced specialist.' },

    // IJSBAD ONLY
    'r.svc.ijsbad.name': { nl: 'IJsbad only — 10 min',    en: 'Ice Bath only — 10 min' },
    'r.svc.ijsbad.desc': { nl: 'Een frisse duik voor de echte ijsvogels onder ons. Boek je 10 minuten ijsbad sessie!',
                           en: 'A fresh dip for the true ice birds among us. Book your 10-minute ice bath session!' },

    // MEN
    'r.svc.menbeard.name': { nl: 'Heren Special | Baard only — 35 min', en: "Men's Special | Beard only — 35 min" },
    'r.svc.menbeard.desc': { nl: 'Sauna + ijsbad + baard trim + whiskey (inclusief een warm handoekje voor het gezicht). Wat wilt een man nog meer, net voordat het weekend begint?',
                             en: 'Sauna + ice bath + beard trim + whiskey (including a warm towel for the face). What more does a man need, right before the weekend?' },
    'r.svc.menhair.name': { nl: 'Heren Special | Haar only — 45 min',  en: "Men's Special | Hair only — 45 min" },
    'r.svc.menhair.desc': { nl: 'Sauna + ijsbad + haarknip beurt + whiskey. Wat wilt een man nog meer, net voordat het weekend begint?',
                             en: 'Sauna + ice bath + hair cut + whiskey. What more does a man need, right before the weekend?' },
    'r.svc.menfull.name': { nl: 'Heren Special | Haar + Baard — 60 min', en: "Men's Special | Hair + Beard — 60 min" },
    'r.svc.menfull.desc': { nl: 'Sauna + ijsbad + haarknip beurt + baard trim + whiskey (inclusief warm handdoekje voor het gezicht). Wat wilt een man nog meer?',
                            en: 'Sauna + ice bath + hair cut + beard trim + whiskey (including warm towel for the face). What more does a man need?' },

    // STUDIO LUCA
    'r.svc.studio1.name': { nl: 'Studio LUCA — Per uur',    en: 'Studio LUCA — Per hour' },
    'r.svc.studio1.desc': { nl: 'Een rustgevende daglichtstudio voor meetings, fotografie, movement, workshops en meer. Wij openen onze deuren voor iedereen die ruimte zoekt om te creëren, te bewegen of samen te komen. Extra wensen zoals inrichting of lunch zijn beschikbaar op aanvraag.',
                            en: 'A serene daylight studio for meetings, photography, movement, workshops and more. We open our doors for anyone seeking space to create, move or come together. Extra requests like setup or lunch available on request.' },
    'r.svc.studio2.name': { nl: 'Studio LUCA — Per 2 uur',  en: 'Studio LUCA — Per 2 hours' },
    'r.svc.studio2.desc': { nl: 'Een rustgevende daglichtstudio voor meetings, fotografie, movement, workshops en meer. Wij openen onze deuren voor iedereen die ruimte zoekt om te creëren, te bewegen of samen te komen. Extra wensen zoals inrichting of lunch zijn beschikbaar op aanvraag.',
                            en: 'A serene daylight studio for meetings, photography, movement, workshops and more. We open our doors for anyone seeking space to create, move or come together. Extra requests like setup or lunch available on request.' },
    'r.svc.studio3.name': { nl: 'Studio LUCA — Per 3 uur',  en: 'Studio LUCA — Per 3 hours' },
    'r.svc.studio3.desc': { nl: 'Een rustgevende daglichtstudio voor meetings, fotografie, movement, workshops en meer. Wij openen onze deuren voor iedereen die ruimte zoekt om te creëren, te bewegen of samen te komen. Extra wensen zoals inrichting of lunch zijn beschikbaar op aanvraag.',
                            en: 'A serene daylight studio for meetings, photography, movement, workshops and more. We open our doors for anyone seeking space to create, move or come together. Extra requests like setup or lunch available on request.' },
    'r.svc.studio4.name': { nl: 'Studio LUCA — Per dagdeel (4u)', en: 'Studio LUCA — Per half day (4h)' },
    'r.svc.studio4.desc': { nl: 'Een rustgevende daglichtstudio voor meetings, fotografie, movement, workshops en meer. Wij openen onze deuren voor iedereen die ruimte zoekt om te creëren, te bewegen of samen te komen. Extra wensen zoals inrichting of lunch zijn beschikbaar op aanvraag.',
                            en: 'A serene daylight studio for meetings, photography, movement, workshops and more. We open our doors for anyone seeking space to create, move or come together. Extra requests like setup or lunch available on request.' },
    'r.svc.studio5.name': { nl: 'Studio LUCA — Per dag (8u)', en: 'Studio LUCA — Per day (8h)' },
    'r.svc.studio5.desc': { nl: 'Een rustgevende daglichtstudio voor meetings, fotografie, movement, workshops en meer. Wij openen onze deuren voor iedereen die ruimte zoekt om te creëren, te bewegen of samen te komen. Extra wensen zoals inrichting of lunch zijn beschikbaar op aanvraag.',
                            en: 'A serene daylight studio for meetings, photography, movement, workshops and more. We open our doors for anyone seeking space to create, move or come together. Extra requests like setup or lunch available on request.' },
